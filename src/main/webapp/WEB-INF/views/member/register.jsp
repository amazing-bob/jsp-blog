            ...
            <form method="post" action="#">
                <div class="row gtr-uniform">
                    ...
                    <div class="col-6 col-12-xsmall">
                        <input type="text" name="nameTextInput" id="nameTextInput" value="" placeholder="Name" />
                    </div>
                    <div class="col-3 col-12-small"></div>
                    ...
                    <div class="col-6 col-12-large">
                        <ul class="actions">
                            ...
                            <li><input type="button" name="memberRegisterBtn" id="memberRegisterBtn" value="회원가입" class="primary" /></li>
                        </ul>
                    </div>
                    <div class="col-3"></div>
                </div>
